...
| `max sessions` | List active worker sessions from the daemon |
...
The command queries the local daemon and prints a compact table with each active worker's name, current status, and working directory.
